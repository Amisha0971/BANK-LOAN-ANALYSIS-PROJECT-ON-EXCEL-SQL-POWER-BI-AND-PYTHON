------------ **Finance Loan Project queries** ---------------

-------- Retrive all Data ----------------------
SELECT * FROM bank_loan_db.financial_loan;

-------- Safe mode --------------
SET SQL_SAFE_UPDATES = 0;

-------- Update Date columns from text to date ------------
...
-------- Change data type Text into Date ----------
...
-------- Loan Status As Total Payment And Total Amount -----------
SELECT 
	loan_status, 
